...
For moduli stabilization we need $\alpha$-correction to the K\"ahler potential where $\alpha = \frac{1}{2} \xi S_1^{3 / 2}$, $\xi = -\zeta\left(3\right) \chi / \left(16 \pi^3\right)$, and $\chi = h^{1, 1} - h^{1, 2}$ is the topological Euler characteristic of the compactified manifold $X$.
