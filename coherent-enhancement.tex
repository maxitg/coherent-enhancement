...
\begin{equation} \label{eq:LythBound}
  r \approx \frac{8 \Delta \phi^2}{M_\text{P}^2 N^2} \lesssim 0.003\,,
\end{equation}
...
In each case we find that it is possible to construct inflation models where the effective axion decay constant can be larger that $5 M_\text{P}$ needed for successful inflation.
